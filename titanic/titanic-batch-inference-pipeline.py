...
def g():
    ...
    survived_url = "https://raw.githubusercontent.com/xrisaD/ScalableML-Titanic/main/images/" + str(survived) + ".jpg"
    ...
    df = titanic_fg.read()
    # print(df["variety"])
    label = int(df.iloc[-1]["survived"])
    label_url = "https://raw.githubusercontent.com/xrisaD/ScalableML-Titanic/main/images/" + str(int(label)) + ".jpg"
    ...
    df_recent_titanic = history_df.tail(5)
    dfi.export(df_recent_titanic, './df_recent_titanic.png', table_conversion = 'matplotlib')
