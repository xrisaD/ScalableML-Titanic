...
def g():
    ...
    try: 
        ...
        query = titanic_fg.select_except(features=["passengerid"])
    ...
    # Train our model with the Scikit-learn RandomForestClassifier algorithm using our features (X_train) and labels (y_train)
